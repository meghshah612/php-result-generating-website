...
<body> 
    ...
    <div class="title">
        ...
        <span class="heading" style="background:brown; color:white">Dashboard</span>
    ...
    <div class="floating" style=
            ...
            padding: 10px">
        *Welcome Admin, Here you can administrate the student data using the links provided above*
    </div>
    </marquee>
