...
<body>
    ...
    <div class="title">
        ...
        <span class="heading" style="background:brown; color:white">Results Section</span>
    ...
    <div class="floating" style=
            "height: 30px; width: 600px; color:red;
            background: rgb(200, 255, 200);
            padding: 10px">
        *Enter student class name and roll no to delete his/her result data from the database*
    </div>
    </marquee>
